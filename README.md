...
> Адреса на Render остались от рабочего названия «Дотяну»: переименование сервисов сменило бы URL и сломало деплой перед защитой. В интерфейсе продукт называется «ФинКом».

"""Временная копия раздела 8 CONTRACT.md. Удалить, когда D положит app/data/personas.json."""
...
DANYA = {
    ...
    "incomes": [
        {"id": "i1", "name": "Подработка курьером", "amount": 4000, "date": "2026-10-03", "confirmed": False},

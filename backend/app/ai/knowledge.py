...
FALLBACK_TERMS: list[dict] = [
    ...
    {"term": "Рассрочка",
     "aliases": ["рассрочка"],
     "definition": "Покупка, которую вы оплачиваете частями. Каждый будущий платёж — это обязательный расход, "
    ...
    {"term": "Кредитный лимит",
     ...
     "definition": "Деньги банка, которые можно потратить и потом вернуть, часто с процентами. "
                   "Это не ваш остаток: в прогнозе мы его не учитываем."},
    {"term": "Вклад",
     "aliases": ["вклад", "депозит"],
     "definition": "Деньги, которые вы кладёте в банк на срок под процент. Снять раньше срока обычно можно, "
                   "но проценты при этом теряются."},
    {"term": "Инфляция",
     "aliases": ["инфляция"],
     "definition": "Рост цен со временем: на ту же сумму через год купите меньше. Поэтому деньги, "
